...
class BashGastToCodeConverter():
    ...
    def handle_arr(self, gast):
        ...
        if general_helpers.arr_in_list(gast["elements"]):
            return self.error_handler.impossible_translation(["https://stackoverflow.com/a/11234169", "https://github.com/pppoe/Nested-Array-Bash"])
    ...
    def handle_bool(self, gast):
        return self.error_handler.impossible_translation(["https://stackoverflow.com/a/47092826", "https://github.com/Jeff-Russ/bash-boolean-helpers"])
