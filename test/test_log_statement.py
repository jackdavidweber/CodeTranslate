...
class TestLogStatement(unittest2.TestCase):
    ...
    def test_arrays(self):
        ...
        java_code = Unittest('System.out.println(Arrays.toString(new int[][] {{1, 3}, {3, 4}}));', 'java', is_input=False)
    ...
    def test_none(self):
        ...
        java_code = Unittest('System.out.println(null);', 'java', is_input=False)
        matrix.matrix(self, [py_code, js_code, java_code])

    def test_log_arr_to_code(self):
        py_code = Unittest('print([1, 2, 3])', "py")
        java_output = Unittest('System.out.println(Arrays.toString(new int[] {1, 2, 3}));', 'java', is_input=False)
