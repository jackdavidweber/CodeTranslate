...
class TestLogStatement(unittest2.TestCase):
    ...
    def test_no_args(self):
        self.assertEqual('console.log()', translate.translate('print()', 'py', 'js'))
        self.assertEqual('print()', translate.translate('console.log()', 'js', 'py'))

    def test_one_arg(self):
        self.assertEqual('console.log("hello")',
                         translate.translate('print("hello")', 'py', 'js'))
        self.assertEqual('print(5)', translate.translate('console.log(5)', 'js', 'py'))
        self.assertEqual('echo 8', translate.translate('console.log(8)', 'js', 'bash'))
